        ...
        <div className='bg-[#F5F5F5] lg:rounded-bl-full lg:rounded-br-full'>
            ...
            <div id='mobile-menu'  className=" shadow-md shadow-primary pb-2 hidden text-[20px] flex-col mt-[60px] w-full justify-center items-center " >
                ...
                {pageNumber === 3 ? <h1 className=' w-fit border-b-4 border-secondary cursor-not-allowed font-serif font-semibold text-primary '>Hostels</h1> : <h1 className=' cursor-pointer hover:text-primary hover:opacity-70 hover:border-b-4 hover:border-[#d1e0e0]  ' onClick={() => dispatch(hostels())} >Hostels</h1>} */}
                    {pageNumber === 1 ? <h1 className=' w-fit border-b-4  border-secondary cursor-not-allowed font-serif font-semibold text-primary '>About Us</h1> : <h1 className=' cursor-pointer hover:text-primary hover:opacity-70 hover:border-b-4 hover:border-[#d1e0e0]  ' onClick={() => dispatch(about_us()) && navigate("/about")} >About Us</h1>}
                    {pageNumber === 2 ? <h1 className=' w-fit border-b-4  border-secondary cursor-not-allowed font-serif font-semibold text-primary '>Contact Us</h1> : <h1 className=' cursor-pointer hover:text-primary hover:opacity-70 hover:border-b-4 hover:border-[#d1e0e0]  ' onClick={() => dispatch(contact_us()) && navigate("/contact")} >Contact Us</h1>}
                </div>
            </div>
        </div>
    )
