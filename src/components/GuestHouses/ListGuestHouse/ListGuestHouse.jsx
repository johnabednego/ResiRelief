...
import {GuestHouseFalse} from '../../../features/page/ListProperty/guestHouseModal'
import { useDispatch } from "react-redux";

const ListGuestHouse = () => {
  const dispatch = useDispatch()
  return (
    <div className=" justify-center items-center flex flex-col">
      <button onClick={()=>dispatch(GuestHouseFalse())} className="closeButton -mt-5 rounded-[4px] select-none box-border flex justify-center items-center text-center p-1 ml-auto  border-0  float-right text-3xl leading-none font-semibold outline-none focus:outline-none">
      ...
      <h1 className=" px-2 text-primary text-center  text-[25px]">
        Are you listing your Guest House for booking?
      </h1>
      {/* Booking*/}
      <div
        data-aos="fade-left"
        ...
        <div className=" items-center text-center justify-center  box-border flex flex-col">
          <div className=" box-border">
            ...
            <p className="text-[14px] text-center w-[200px] sm:w-[300px]">
              You are listing your guest house to tenants, and require monthly
