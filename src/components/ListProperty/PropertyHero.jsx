    ...
    <div className="overflow-hidden pb-8">
      <div className=" h-full w-full relative ">
        ...
        <div className=" pt-28 lg:pt-16 bg-white">
          ...
          data-aos-duration="3000" className=" h-fit sm:h-auto basis-full box-border rounded-[16px] px-3 sm:px-0 listType relative flex flex-grow flex-shrink sm:basis-0 bg-white w-full max-w-full md:max-w-[542px] min-h-[230px] border-[1px] border-solid border-[#3171d9] overflow-hidden  ">
              <div className=" listTittle box-border mt-6 lg:mt-6 mr-[212px] md:mr-[150px] lg:mr-[212px] mb-0 ml-4 flex flex-col justify-between">
                ...
                <button className=" listButton min-w-[175px] w-fit mx-0 my-4 text-white bg-[#3171d9] border-[#3171d9] rounded-[100px] min-h-[42px] inline-block font-semibold text-center touch-manipulation cursor-pointer border-[1px] border-solid border-transparent whitespace-nowrap text-[14px] select-none px-[15px] py-[10px]">
