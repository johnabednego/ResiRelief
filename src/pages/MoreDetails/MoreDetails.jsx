...
import Overview from "../../components/Search/Overview";
import { useLocation, useNavigate } from 'react-router-dom';
import Room from "../../components/Search/Room";
import Facilities from "../../components/Search/Facilities";
import Policies from "../../components/Search/Policies";
import Review from "../../components/Search/Review";
import PicturesModal from "../../components/Search/PicturesModal";
            ...
            <div className=" mb-6 flex flex-col items-center justify-center w-full h-fit ">
              ...
              <div className=" mt-6 text-[#4E4E4E] relative bg-white box-border w-full h-fit text-left text-sm justify-center items-center flex flex-wrap">
                ...
                <div className=" px-2 border-[1px] border-y-[1px] border-solid h-[55.99px] flex justify-center items-center">
                  <div onClick={()=>booking(state)} className=" shadow-md shadow-primary cursor-pointer rounded-10xs bg-[#5392F9] flex flex-row pt-[5px] pb-[7px] pr-[6px] pl-1.5 items-start justify-start text-center text-white">
                    <b className=" leading-[19.6px]">Book now</b>
                  </div>
                </div>
              </div>
            </div>
